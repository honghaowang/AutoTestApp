...
public class DBhelper extends SQLiteOpenHelper{
    ...
    **/
    public static final String CREATE_SOURCE_INFO_TABLE = "CREATE TABLE IF NOT EXISTS " +DBcontract.LogEntry.TABLE_SOURCE_INFO + " ("
            ...
            + DBcontract.LogEntry.COLUMN_WINDOW_TYPE + " TEXT)";
...
//    public static final String DELETE_CONTEXT_INFO_TABLE = "DROP TABLE IF EXISTS " + DBcontract.LogEntry.TABLE_CONTEXT_INFO;
    public static final String DELETE_SOURCE_INFO_TABLE = "DROP TABLE IF EXISTS " + DBcontract.LogEntry.TABLE_SOURCE_INFO;
    ...
    public void createDatabase(SQLiteDatabase db){
        ...
        db.execSQL(CREATE_SOURCE_INFO_TABLE);
    }
    ...
    public void deleteDatabase(SQLiteDatabase db){
        ...
        db.execSQL(DELETE_SOURCE_INFO_TABLE);
    }
